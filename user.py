...
def dehaze_and_detect_video():
    ...
    print("Starting video dehazing and person counting. Press 'q' to quit.")
    ...
    while True:
        ...
        if frame_count % int(fps) == 0:
            ...
            cv2.imshow('Dehazed Person Detection in Video', dehazed_frame)
            print(overlay_text)
